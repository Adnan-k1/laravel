...
<a href="/student" 
   class="rounded-md px-3 py-2 text-sm font-medium 
   {{ request()->is('student') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">
   Student
</a>

<a href="/guardian" 
   class="rounded-md px-3 py-2 text-sm font-medium 
   {{ request()->is('guardian') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' }}">
   Guardian
</a>
          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <el-dropdown class="relative ml-3">
              <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                ...
                <img src="https://th.bing.com/th/id/OIP._d3qez1IuMEysncY9Ge6owHaEh?w=265&h=181&c=7&r=0&o=7&dpr=2&pid=1.7&rm=3" alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
              </button>
